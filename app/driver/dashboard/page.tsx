      ...
      <main className="container mx-auto px-4 sm:px-6 py-6">
        {!profile?.restaurantId ? (
          <div className="max-w-md mx-auto bg-white p-6 sm:p-8 rounded-xl shadow-sm border border-gray-100 text-center">
            ...
            <h2 className="mt-6 text-xl font-semibold text-gray-900">Seu Código de Entregador</h2>
            <p className="mt-2 text-gray-500">Compartilhe este código com o proprietário do restaurante.</p>
          ...
          <div className="max-w-md mx-auto p-8 text-center">
            ...
            <h2 className="mt-6 text-xl font-semibold text-gray-700">Nenhuma entrega no momento</h2>
            <p className="mt-2 text-gray-500">Novos pedidos aparecerão aqui automaticamente</p>
          </div>
        ) : (
  ...
  >
    <div className="p-5 sm:p-6">
      <div className="flex flex-col sm:flex-row justify-between gap-4">
        <div>
          <p className="text-xs font-medium text-gray-500 uppercase tracking-wider">Pedido #</p>
