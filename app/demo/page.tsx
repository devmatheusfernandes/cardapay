...
const features = [
  {
    ...
    description: "Adicione seus pratos, bebidas e categorias com fotos e descrições. Nosso painel intuitivo torna o gerenciamento do seu menu uma tarefa simples e rápida.",
    image: Demo3, // CHANGE 2: Assign the image object directly
  },
  {
    icon: Smartphone,
    title: "Receba Pedidos em Tempo Real",
    description: "Seus clientes escaneiam o QR code, fazem o pedido e pagam diretamente pelo celular. Você recebe as novas ordens instantaneamente no seu painel, prontas para serem preparadas.",
    image: Demo2, // Assign the image object directly
  },
  {
    icon: BarChart3,
    title: "Analise e Otimize suas Vendas",
    description: "Acesse relatórios detalhados sobre seus pedidos, receita e itens mais vendidos. Use esses dados para entender seus clientes e tomar decisões mais inteligentes para o seu negócio.",
  ...
  return (
    <div className="bg-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        ...
        >
          <h2 className="text-3xl font-bold text-slate-800">Pronto para Começar?</h2>
          <p className="text-lg text-slate-600 mt-3">
            Escolha um plano e comece a transformar seu negócio hoje mesmo.
          </p>
          <Link
            href="/#pricing"
            className="mt-8 inline-block bg-rose-600 text-white font-semibold px-8 py-4 rounded-lg shadow-lg hover:bg-rose-700 transition-transform transform hover:scale-105"
          >
            Ver Planos e Preços
          </Link>
        </motion.div>
