        ...
        <div className="p-4 sm:p-6 lg:p-8">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between md:items-center gap-4 mb-8">
              <h1 className="text-3xl font-bold text-slate-800">Gerenciamento de Entregadores</h1>
              <motion.button
...
const AssociateDriverModal = ({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Adicionar Entregador por Código">
      <form onSubmit={handleSubmit} className="space-y-4">
        <p className="text-sm text-slate-600">
          Peça ao entregador o código único que ele recebeu ao se cadastrar e insira-o abaixo.
        </p>
        <InputField
          icon={Key}
          name="code"
        ...
        <div className="flex justify-end gap-4 pt-4">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="px-4 py-2 bg-rose-600 text-white rounded-lg hover:bg-rose-700 transition flex items-center gap-2 disabled:bg-rose-400"
          >
