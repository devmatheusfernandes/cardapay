// app/waiter/dashboard/waiter/[tableId]/page.tsx
"use client";
...
import { useWaiter, WaiterOrderItem, Seat } from "@/lib/hooks/useWaiter";
...
export default function TablePage() {
  ...
  const [personToEdit, setPersonToEdit] = useState<PersonWithName | null>(null);
  ...
  const handleGoToPayment = async () => {
    ...
    if (tableState.isInPayment) {
      ...
      if (tableState.isInPayment) {
        ...
        router.push(`/waiter/dashboard/billing`); // Updated route for waiter
      } else {
    ...
    if (billId) {
      router.push(`/waiter/dashboard/billing/${billId}`);
    }
  };
